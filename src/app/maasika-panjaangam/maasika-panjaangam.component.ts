...
@Component({
  selector: 'maasika-panjaangam',
  templateUrl: './maasika-panjaangam.component.html',
  styleUrls: ['./maasika-panjaangam.component.css']
})
export class MaasikaPanjaangamComponent implements OnInit {
